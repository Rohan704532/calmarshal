    ...
    return (
        <div className="py-24">
            <div className="max-w-2xl mx-auto lg:text-center">
                ...
                <p className="mt-6 text-base leading-snug text-muted-foreground">With SchedEase you can schedule meetings in minute. We make it easy for you to schedule meetings in minute. The meetings are very fast and easy to schedule.</p>
            </div>
